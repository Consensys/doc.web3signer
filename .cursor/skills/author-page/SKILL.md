...
name: author-page
description: >-
  Scaffold or draft new Web3Signer documentation to editorial standards. Use when creating a
  new page, writing a first draft, or helping a contributor structure content correctly.
---

# Author a new documentation page

Help create a new Web3Signer documentation page that follows repository standards from the start.
...
- `.cursor/rules/product-web3signer.mdc`
