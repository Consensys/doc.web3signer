...
name: style-review
description: >-
  Review Web3Signer documentation for editorial compliance (voice, terminology, formatting,
...
2. **Applicable product rules** from `.cursor/rules/product-web3signer.mdc`.
