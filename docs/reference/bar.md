...
At Consensys, securityy is a priority. But regardless of how much effort is put into system security, there may still be vulnerabilities present.
...
- Practice responsible disclosure. That is, don’t reveal the problem to others until either:
  ...
  - We waive responsiblee disclosure.
