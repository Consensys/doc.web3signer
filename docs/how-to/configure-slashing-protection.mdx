...
the [`--slashing-protection-enabled`](../reference/cli/subcommands#slashing-protection-enabled)
command line option.
:::
...
[`slashing-protection-db-pool-configuration-file`](../reference/cli/subcommands#slashing-protection-db-pool-configuration-file)
option.
:::
...
Including
[`--slashing-protection-pruning-enabled=true`](../reference/cli/subcommands#slashing-protection-pruning-enabled)
...
Use the [`eth2 import`](../reference/cli/subcommands#eth2-import) and
[`eth2 export`](../reference/cli/subcommands#eth2-export) to import or export files.
...
[`--slashing-protection-pruning-enabled`](../reference/cli/subcommands#slashing-protection-pruning-enabled)
to `true`.
...
[`--slashing-protection-pruning-at-boot-enabled`](../reference/cli/subcommands#slashing-protection-pruning-at-boot-enabled)
to `true`.
...
[`--slashing-protection-db-health-check-interval-milliseconds`](../reference/cli/subcommands#slashing-protection-db-health-check-interval-milliseconds)
command line option.
...
[`--slashing-protection-db-health-check-timeout-milliseconds`](../reference/cli/subcommands#slashing-protection-db-health-check-timeout-milliseconds)
command line option.
