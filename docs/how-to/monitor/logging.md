...
Use the [`--logging`](../../reference/cli/options#logging) command line option to specify logging verbosity.
The [`--logging`](../../reference/cli/options#logging) option changes the volume of events
